    ...
    <form action="#" class="grid grid-cols-12 gap-8 pb-20">
        <div class="col-span-7 space-y-6">
            ...
            <div class="flex items-center gap-4 pt-4">
                <a href="{{ route('post') }}" class="px-8 py-2.5 border border-gray-300 rounded-lg text-gray-600 font-medium hover:bg-gray-50">Cancel</a>
            </div>
        </div>
        ...
        <div class="col-span-5 space-y-8">
            <div class="bg-gray-200/70 rounded-xl p-6">
                ...
                <div class="grid grid-cols-2 gap-y-4 gap-x-2">
                    ...
                    <label class="flex items-center gap-3 text-xs text-gray-700 cursor-pointer group">
                        <input type="checkbox" class="w-4 h-4 rounded border-gray-300 text-[#0C1C87] accent-[#0C1C87]">
            ...
            <div class="flex justify-end gap-4 pt-10">
                ...
                <button type="submit" class="px-8 py-2.5 bg-[#0C1C87] text-white rounded-lg font-bold hover:bg-[#0B1357] shadow-lg">Publish Now</button>
            </div>
        </div>
    </form>
@endsection