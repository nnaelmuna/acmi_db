            ...
            <form action="#" class="grid grid-cols-12 gap-8 pb-20">
                ...
                <div class="col-span-5 space-y-8">
                    ...
                    <div>
                        ...
                        <div class="border-2 border-gray-300 rounded-xl bg-white aspect-square flex flex-col items-center justify-center cursor-pointer hover:bg-gray-50 transition-all border-dashed group">
