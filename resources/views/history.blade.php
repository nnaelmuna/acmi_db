...
@section('content')
    <div class="w-full space-y-6">
                ...
                <table class="w-full text-left">
                    <thead>
                        <tr class="border-b border-gray-100">
                            ...
                            <th class="py-4 px-4 text-sm font-semibold text-blue-600 uppercase tracking-wider">Total Members
                            </th>
        ...
        <a href="{{ route('dashboard') }}"
            class="inline-flex items-center gap-2 text-sm font-medium bg-acmi-blueprimer px-3 rounded-lg py-2 text-white hover:bg-[#0A1B89] transition-colors">
