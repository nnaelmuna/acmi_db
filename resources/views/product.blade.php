...
@section('content')
    ...
    <div class="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
        <div class="flex items-center gap-3 w-full xl:w-auto">
            ...
            <div class="relative group flex-1 xl:flex-none">
                ...
                <div id="catSlider" class="flex no-scrollbar overflow-x-auto scroll-smooth items-center gap-2 rounded-2xl border border-gray-200 bg-[#F6F6F6] p-1.5 max-w-[300px] md:max-w-[500px] lg:max-w-[700px]">
                    ...
                    @foreach ($categories as $cat)
                        <a id="slider-cat-{{ $cat->id }}" href="{{ route('product.index', ['category' => $cat->name]) }}"
            ...
            <button type="button" onclick="openCategoryModal()" class="flex h-10 w-10 ml-3 shrink-0 items-center justify-center rounded-xl bg-white border border-gray-100 text-gray-400 shadow-sm transition hover:text-[#0014A8]">
