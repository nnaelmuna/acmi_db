    ...
    <form action="{{ route('post.update', $post) }}" enctype="multipart/form-data" method="POST"
        ...
        <div class="space-y-6 xl:col-span-7">
            ...
            <div>
                ...
                <input type="text" name="title" value="{{ old('title', $post->title) }}" {{-- ✅ Diisi data lama --}}
            ...
            <div>
                ...
                <textarea rows="2" name="description" placeholder="Write a short summary..."
                    class="w-full rounded-xl border border-gray-300 bg-white px-4 py-3 text-sm text-gray-800 placeholder:text-gray-400 focus:border-acmi-blueprimer focus:outline-none focus:ring-2 focus:ring-acmi-blueprimer/20">{{ old('description', $post->description) }}</textarea> {{-- ✅ Diisi data lama --}}
            </div>
            ...
            <div>
                ...
                <div class="overflow-hidden rounded-2xl border border-gray-300 bg-white">
                    <textarea id="acmi-editor" name="content" rows="15"
                        class="w-full resize-none p-4 text-sm text-gray-800 placeholder:text-gray-400 focus:outline-none">{{ old('content', $post->content) }}</textarea> {{-- ✅ Diisi data lama --}}
                </div>
            </div>
        </div>
            ...
            <div>
                ...
                <div id="dropZone" onclick="document.getElementById('imageInput').click()"
                    ...
                    <div id="uploadPlaceholder"
                        class="{{ $post->image ? 'display:none' : 'flex' }} flex-col items-center justify-center">
