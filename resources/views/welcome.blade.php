...
@section('content')
    ...
    <section class="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div class="relative z-10 text-center px-6 max-w-4xl">
            ...
            <div class="mt-8 flex justify-center gap-4 flex-wrap">
                <button
                    class="px-6 py-3 bg-orange-500 text-white rounded-lg font-semibold shadow hover:bg-orange-600 transition">
                    Gabung Keanggotaan
                </button>
                <button
                    class="px-6 py-3 border border-orange-400 text-orange-500 rounded-lg font-semibold hover:bg-orange-50 transition">
        ...
        <div class="text-center">
            ...
            <div class="mt-10 grid grid-cols-2 md:grid-cols-6 gap-4 max-w-5xl mx-auto px-6">
                @foreach (['BCA', 'TELKOM', 'PERTAMINA', 'ASTRA', 'INDOFOOD', 'SINARMAS'] as $partner)
                    <div
                        class="bg-white/60 hover:-translate-y-1 hover:shadow-xl transition backdrop-blur-lg rounded-xl py-4 border border-gray-200">
    ...
    <section class="bg-white px-6 md:px-10 pt-10 pb-6">
        <div class="max-w-7xl mx-auto">
            <div
                class="bg-[#f5f5f7] border border-gray-200 rounded-2xl px-8 py-6 flex flex-col md:flex-row items-center justify-between shadow-sm gap-6">
                <div class="flex items-center gap-5">
                    <div
                        class="w-14 h-14 bg-orange-100 text-orange-500 rounded-xl flex items-center justify-center text-xl">
                        <i class="fa-solid fa-sparkles"></i>
                    </div>
                    <div>
                        <span
                            class="text-xs font-semibold bg-orange-100 text-orange-500 px-3 py-1 rounded-full uppercase tracking-wider">
                            Event Eksklusif
                        </span>
    ...
    <section class="bg-white px-6 md:px-10 py-20">
        <div class="max-w-7xl mx-auto flex flex-col gap-16">
            ...
            <div class="text-center max-w-4xl mx-auto">
                <div
                    class="inline-block px-4 py-1 rounded-full bg-orange-100 text-orange-500 text-xs font-poppins font-semibold mb-6 uppercase tracking-widest">
                    Tantangan Pemimpin
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                @php
                    $challenges = [
                        [
                            'icon' => 'fa-users',
                            'title' => 'Isolasi Strategis',
                            'desc' => 'Kurangnya forum sejawat untuk berdiskusi dan validasi ide bisnis strategis.',
                        ],
                        [
                            'icon' => 'fa-bolt',
                            'title' => 'Perubahan Terlalu Cepat',
                            'desc' => 'Sulit mengikuti tren digital, regulasi, dan perkembangan ekonomi global.',
                        ],
                        [
                            'icon' => 'fa-lock',
                            'title' => 'Keterbatasan Akses',
                            'desc' => 'Ke jaringan tingkat tinggi, mitra strategis, atau pakar kunci industri.',
                        ],
                        [
                            'icon' => 'fa-bullseye',
                            'title' => 'Pengembangan Diri',
                            'desc' => 'Kebutuhan tetap relevan dan visionary sebagai pemimpin bisnis.',
                        ],
                    ];
                @endphp
                ...
                @foreach ($challenges as $item)
                    <div
                        class="bg-[#f5f5f7] border border-gray-200 rounded-2xl p-8 text-left hover:-translate-y-2 hover:shadow-xl transition duration-300 group">
                        <div
                            class="w-12 h-12 bg-orange-100 text-orange-500 rounded-xl flex items-center justify-center text-lg mb-6 group-hover:bg-orange-500 group-hover:text-white transition duration-300">
    ...
    <section class="relative min-h-screen w-full flex items-center justify-center py-24 px-6 overflow-hidden">
        ...
        <div class="relative z-10 max-w-7xl w-full grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div class="space-y-10">
                <div>
                    <span
                        class="inline-block px-4 py-1 rounded-full border border-orange-200 bg-orange-50 text-orange-600 text-xs font-poppins font-semibold mb-6 uppercase tracking-wider">
                        Solusi ACMI
                    </span>
                    ...
                    <p class="mt-8 text-gray-600 text-base md:text-lg font-poppins max-w-lg leading-relaxed">
                        Kami menyediakan ekosistem yang dirancang khusus untuk menjawab tantangan para pemimpin bisnis
                        Indonesia dengan pendekatan yang holistik dan eksklusif.
                    </p>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                @php
                    $solutions = [
                        [
                            'icon' => 'fa-share-nodes',
                            'title' => 'Networking Berkualitas Tinggi',
                            'desc' =>
                                'Terhubung dengan sesama CEO & founders dari berbagai industri dalam forum privat dan eksklusif.',
                        ],
                        [
                            'icon' => 'fa-book-open',
                            'title' => 'Knowledge Sharing Eksklusif',
                            'desc' =>
                                'Roundtable discussion, masterclass dengan pakar global, dan insight industri terkurasi.',
                        ],
                        [
                            'icon' => 'fa-bullhorn',
                            'title' => 'Amplifikasi Pengaruh',
                            'desc' =>
                                'Advokasi kebijakan bersama dan platform untuk memperkuat brand leadership pribadi & perusahaan.',
                        ],
                        [
                            'icon' => 'fa-briefcase',
                            'title' => 'Akses ke Peluang Bisnis',
                            'desc' =>
                                'Deal flow, joint venture, dan rekomendasi mitra strategis melalui jaringan kepercayaan.',
                        ],
                    ];
                @endphp
                ...
                @foreach ($solutions as $sol)
                    <div
                        class="bg-white/70 backdrop-blur-md p-8 rounded-2xl border border-gray-100 shadow-sm hover:shadow-lg transition duration-300">
                        <div
                            class="w-12 h-12 bg-orange-500 rounded-lg flex items-center justify-center text-white mb-6 shadow-orange-200 shadow-lg">
    ...
    <section class="py-24 bg-white px-6">
        <div class="max-w-7xl mx-auto">
            <div class="text-center mb-16">
                <span
                    class="inline-block px-4 py-1.5 rounded-full border border-orange-100 bg-orange-50 text-orange-500 text-xs font-semibold mb-6 tracking-wide">
                    Program Unggulan
                </span>
                <h2 class="text-4xl md:text-5xl font-poppins text-[#1a1a1a] leading-tight">
                    ...
                    <span class="font-serif font-bold italic text-orange-500">Kepemimpinan & Bisnis</span> <span
                        class="font-semibold">Anda</span>
                </h2>
                <p class="mt-6 text-gray-500 text-base md:text-lg font-poppins max-w-2xl mx-auto leading-relaxed">
                    Program-program berkualitas tinggi yang dirancang untuk memenuhi kebutuhan pengembangan para eksekutif
                    puncak.
                </p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                @php
                    $programs = [
                        [
                            ...
                            'desc' =>
                                'Sesi diskusi tertutup dan confidential tentang tantangan strategis dengan sesama CEO.',
                            'is_featured' => false,
                        ],
                        [
                ...
                @foreach ($programs as $program)
                    <div
                        class="group relative bg-[#f8f9fb] border {{ $program['is_featured'] ? 'border-orange-200' : 'border-transparent' }} p-10 rounded-4xl hover:bg-white hover:shadow-2xl hover:shadow-orange-100 transition-all duration-500">
                        <div
                            class="w-14 h-14 bg-orange-500 rounded-2xl flex items-center justify-center text-white mb-8 shadow-lg shadow-orange-200 group-hover:scale-110 transition-transform duration-500">
                            <i class="fa-solid {{ $program['icon'] }} text-xl"></i>
                        </div>

                        <h3
                            class="text-xl font-bold text-gray-900 font-poppins mb-4 group-hover:text-orange-500 transition-colors">
                            {{ $program['title'] }}
                        </h3>
    ...
    <section class="relative py-24 overflow-hidden">
        ...
        <div class="relative z-10 max-w-7xl mx-auto px-6">
            ...
            <div class="text-center mb-20">
                <div
                    class="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-orange-100 bg-white/80 text-orange-500 text-xs font-semibold mb-6 tracking-wide shadow-sm">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
                @php
                    $testimonials = [
                        [
                            ...
                            'quote' =>
                                '"ACMI bukan sekadar asosiasi, tapi ekosistem pendukung terkuat. Jaringannya memberikan nilai yang tak terukur, dari strategi bisnis hingga pengembangan diri sebagai pemimpin."',
                        ],
                        [
                            'name' => 'Sarah Wijaya',
                            ...
                            'quote' =>
                                '"Bergabung dengan ACMI membuka akses ke jaringan CEO terbaik Indonesia. Setiap pertemuan selalu menghasilkan insight berharga untuk bisnis saya."',
                        ],
                        [
                            'name' => 'Herman Tanaka',
                            ...
                            'bg_initial' => 'bg-orange-500',
                            'quote' =>
                                '"Program peer advisory ACMI membantu saya mengambil keputusan strategis dengan lebih percaya diri. Forum diskusi yang confidential."',
                        ],
                    ];
                @endphp
                ...
                @foreach ($testimonials as $testi)
                    <div
                        class="group bg-white/70 backdrop-blur-md border border-white p-10 rounded-[2.5rem] shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_20px_50px_rgba(249,115,22,0.1)] transition-all duration-500 flex flex-col justify-between border-opacity-50">

                        <div>
                            {{-- Quote Icon ala Gambar --}}
                            <div class="mb-6">
                                <i
                                    class="fa-solid fa-quote-left text-4xl text-orange-200 group-hover:text-orange-400 tracking-wider transition-colors duration-500"></i>
                            </div>
                        ...
                        <div class="flex items-center gap-4 pt-6">
                            <div
                                class="w-12 h-12 {{ $testi['bg_initial'] }} text-white rounded-full flex items-center justify-center font-bold font-poppins shadow-lg group-hover:scale-110 transition-transform duration-500">
                                {{ $testi['initial'] }}
                            </div>
                            <div>
                                <h4 class="text-slate-900 font-bold font-poppins text-[13px] tracking-tight">
                                    {{ $testi['name'] }}</h4>
    ...
    <section class="py-24 bg-white px-6">
        <div class="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div class="space-y-8">
                <div>
                    <div
                        class="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-orange-100 bg-white text-orange-400 text-xs font-medium mb-6 shadow-sm">
                    ...
                    <p class="mt-6 text-gray-500 text-base md:text-lg font-poppins leading-relaxed max-w-xl">
                        Keanggotaan ACMI bersifat undangan dan melalui proses kurasi untuk memastikan kualitas dan
                        keselarasan nilai antar anggota. Kami mencari pemimpin yang berkomitmen untuk saling berbagi dan
                        bertumbuh bersama.
                    </p>
                </div>
                ...
                <ul class="space-y-4">
                    ...
                    @foreach ($features as $feature)
                        <li class="flex items-center gap-3 text-slate-700 font-poppins text-sm md:text-base">
                            <div
                                class="shrink-0 w-6 h-6 border-2 border-orange-400 rounded-full flex items-center justify-center">
            ...
            <div class="relative flex justify-center lg:justify-end">
                <div
                    class="bg-[#f8f9fb] border border-gray-100 p-10 md:p-14 rounded-[3rem] w-full max-w-md text-center shadow-[0_20px_50px_rgba(0,0,0,0.03)]">
                    ...
                    <button
                        class="w-full bg-orange-400 hover:bg-orange-500 text-white font-bold py-4 rounded-xl shadow-lg shadow-orange-200 transition-all duration-300 flex items-center justify-center gap-2 group">
                        Ajukan Profil Untuk Dipertimbangkan
                        <i class="fa-solid fa-arrow-right text-sm group-hover:translate-x-1 transition-transform"></i>
                    </button>

                    <p class="mt-8 text-sm text-gray-400 font-poppins">
                        Tertarik menjadi mitra institusional? <a href="#"
                            class="text-orange-400 font-semibold hover:underline">Hubungi Kami</a>
                    </p>
                </div>
            </div>
