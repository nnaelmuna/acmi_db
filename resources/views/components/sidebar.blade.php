    ...
    <div class="space-y-3 text-sm">
      ...
      <div>
        ...
        <div id="crmMenu" class="hidden text-sm bg-[#142062] rounded-lg overflow-hidden">
          <div class="px-6 py-2 hover:text-[#958DFF] cursor-pointer transition-colors duration-200">Inbound</div>
          <div class="px-6 py-2 hover:text-[#958DFF] cursor-pointer transition-colors duration-200">Members</div>
        </div>
      </div>
