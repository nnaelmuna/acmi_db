<aside
    class="w-[260px] min-h-[93vh] ml-6 my-6 bg-[linear-gradient(to_bottom,#0F174A,#0F1964,#0F1A75,#101D8C,#101E98,#4D58C4,#7C87E3)] text-white flex flex-col justify-between p-4 rounded-2xl shadow-2xl">
    ...
    <div>
        ...
        <nav class="space-y-2">
            ...
            <div class="pt-2">
                <button
                    onclick="this.nextElementSibling.classList.toggle('hidden'); this.nextElementSibling.classList.toggle('flex'); this.querySelector('svg').classList.toggle('rotate-180');"
            ...
            <a href="{{ route('sponsored-banner') }}"
                class="flex items-center gap-4 px-4 py-3 rounded-[8px] cursor-pointer transition-all duration-300
                {{ request()->routeIs('sponsored-banner') ? 'bg-[#4155C6]' : 'hover:bg-[#4155C6]/50 opacity-90 hover:opacity-100' }}">
                <i class="fas fa-rectangle-ad"></i>
                <span class="text-[15px] font-medium text-white">Banner Sponsored</span>
            </a>
