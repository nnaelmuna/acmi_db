  ...
  <div>
      ...
      <nav class="space-y-2">
          ...
          <a href="{{ route('dashboard') }}" 
             class="flex items-center gap-4 px-4 py-3 rounded-[8px] cursor-pointer transition-all duration-300 {{ request()->routeIs('dashboard') ? 'bg-[#4155C6]' : 'hover:bg-[#4155C6]/50 opacity-90 hover:opacity-100' }}">
              <div class="w-[22px] h-[22px] bg-gray-300 rounded-full shrink-0"></div>
          ...
          <a href="{{ route('post') }}" 
             class="flex items-center gap-4 px-4 py-3 rounded-[8px] cursor-pointer transition-all duration-300 {{ request()->routeIs('post') ? 'bg-[#4155C6]' : 'hover:bg-[#4155C6]/50 opacity-90 hover:opacity-100' }}">
              <div class="w-[22px] h-[22px] bg-gray-300 rounded-full shrink-0"></div>
              <span class="text-[15px] font-medium text-white">Post</span>
          </a>
          ...
          <div class="pt-2">
              ...
              <div class="hidden flex-col gap-1 bg-[#142062] rounded-lg mt-1 py-2">
                  <a href="#" class="pl-[52px] py-2 text-[14px] text-white hover:text-[#958DFF] transition-colors duration-200">Inbound</a>
                  <a href="#" class="pl-[52px] py-2 text-[14px] text-white hover:text-[#958DFF] transition-colors duration-200">Members</a>
              </div>
          </div>
