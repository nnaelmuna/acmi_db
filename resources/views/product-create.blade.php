        ...
        <div class="bg-white rounded-3xl p-8 shadow-sm border border-gray-100">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                ...
                <div>
                    ...
                    <input type="text" name="title" value="{{ old('title', $product->title ?? '') }}" placeholder="Green Energy Solutions" class="w-full rounded-md border {{ $errors->has('title') ? 'border-red-500' : 'border-gray-300' }} py-2 px-3 caret-[#0014A8] focus:ring-2 focus:ring-[#0014A8]/20 focus:border-[#0014A8] outline-none">
                ...
                <div>
                    ...
                    <input type="text" name="company_name" value="{{ old('company_name', $product->company_name ?? '') }}" placeholder="PT Energi Hijau Indonesia" class="w-full rounded-md border {{ $errors->has('company_name') ? 'border-red-500' : 'border-gray-300' }} py-2 px-3 caret-[#0014A8] focus:ring-2 focus:ring-[#0014A8]/20 focus:border-[#0014A8] outline-none">
            ...
            <div class="grid grid-cols-1 md:grid-cols-12 gap-6 mb-8 relative">
                ...
                <div class="md:col-span-8">
                    <div class="flex flex-wrap gap-4">
                        <div onclick="document.getElementById('mainImageInput').click()" 
                             class="w-32 h-40 bg-white rounded-2xl border-2 border-dashed {{ $errors->has('product_images') ? 'border-red-400' : 'border-gray-200' }} flex flex-col items-center justify-center text-gray-400 cursor-pointer hover:bg-gray-50 hover:border-[#0014A8] transition group shrink-0">
                        ...
                        {{-- Slot 2 & 3 kosong dulu buat upload baru --}}
                ...
                <div class="md:col-span-4">
                    ...
                    <input type="text" name="ceo_name" value="{{ old('ceo_name', $product->ceo_name ?? '') }}" placeholder="Dewi Kusuma" 
                    ...
                    @if(isset($product) && $product->features)
                        @foreach($product->features as $feature)
                            <div class="flex items-center gap-3 bg-white p-3 rounded-xl border border-gray-100 shadow-sm">
                                <div class="w-5 h-5 rounded border border-gray-300 flex items-center justify-center text-[#0014A8]">
                ...
                <div class="space-y-3">
                    ...
                    <div class="relative">
                        <div class="flex items-center gap-3">
                            ...
                            <input type="text" name="website" value="{{ old('website', $product->website ?? '') }}" placeholder="https://energihijau.co.id" 
                        ...
                        @error('website') <p class="text-red-500 text-[10px] mt-1 ml-13" style="margin-left: 3.25rem;">{{ $message }}</p> @enderror
                    </div>
                    ...
                    <div class="relative">
                        <div class="flex items-center gap-3">
                            ...
                            <input type="email" name="email" value="{{ old('email', $product->email ?? '') }}" placeholder="contact@energihijau.co.id" 
                        ...
                        @error('email') <p class="text-red-500 text-[10px] mt-1 ml-13" style="margin-left: 3.25rem;">{{ $message }}</p> @enderror
                    </div>
                    ...
                    <div class="relative">
                        <div class="flex items-center gap-3">
                            ...
                            <input type="text" name="phone" value="{{ old('phone', $product->phone ?? '') }}" placeholder="+62 21 5555 0202" 
                        ...
                        @error('phone') <p class="text-red-500 text-[10px] mt-1 ml-13" style="margin-left: 3.25rem;">{{ $message }}</p> @enderror
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    document.querySelectorAll('input, textarea, select').forEach(el => {
        el.addEventListener('input', function() {
            ...
            if (err) err.remove();
            this.classList.replace('border-red-500', 'border-gray-300');
        });
    });
</script>
@endsection